<template>
  <div class="card">
    <div class="card-header">
      <h4 class="card-title"><strong>Add Beneficiary</strong></h4>
    </div>
    <div class="card-body">
      <Form v-slot="{ errors }" :validation-schema="schema" validation-on-mount @submit="$ben.StoreAPI()">
        ...
        <div class="card-body">
          ...
          <button :disabled="Object.keys(errors).length != 0" type="submit"
            class="btn btn-info float-right mr-1">Add</button>
