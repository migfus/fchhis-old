                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.start" name="start_age" type="text"
                                        ...
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.end" name="end_age" type="text"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.spot_payment" name="spot_payment" type="text"
