                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-6">
                      ...
                      <Field v-model="$plan.params.age_start" name="start_age" type="text" class="form-control"
                    ...
                    <div class="col-6">
                      ...
                      <Field v-model="$plan.params.age_end" name="end_age" type="text" class="form-control" id="end-input"
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-6">
                      ...
                      <Field v-model="$plan.params.spot_pay" name="spot_payment" type="text" class="form-control"
