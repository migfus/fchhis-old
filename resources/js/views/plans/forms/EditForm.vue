                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <QuillEditor v-model:content="$plan.params.desc" contentType="html" theme="snow"
                                        style="height: 300px" placeholder="Place" />
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <Field v-model="$plan.params.name" name="name" type="text" class="form-control"
                                        id="name-input" placeholder="Enter Plan's Name" />
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.age_start" name="start_age" type="text"
                                                class="form-control" id="start-input" placeholder="Enter Start Age" />
                                            <div class="mb-2 text-danger">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.age_end" name="end_age" type="text"
                                                class="form-control" id="end-input" placeholder="Enter End Age" />
                                            <div class="mb-2 text-danger">
                                ...
                                <div class="form-group">
                                    ...
                                    <Field v-model="$plan.params.contract_price" name="contract_price" type="text"
                                        class="form-control" id="contract-price" placeholder="Enter Contract Price" />
                                    <div class="mb-2 text-danger">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.spot_pay" name="spot_payment" type="text"
                                                class="form-control" id="spot_payment" placeholder="Enter Spot Payment" />
                                            <div class="mb-2 text-danger">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.spot_service" name="spot_service" type="text"
                                                class="form-control" id="spot_service" placeholder="Enter Spot Service" />
                                            <div class="mb-2 text-danger">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.annual" name="annually" type="text"
                                                class="form-control" id="annually" placeholder="Enter Annual" />
                                            <div class="mb-2 text-danger">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.semi_annual" name="semi_annually" type="text"
                                                class="form-control" id="semi_annually" placeholder="Enter Semi-Annual" />
                                            <div class="mb-2 text-danger">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.quarterly" name="querterly" type="text"
                                                class="form-control" id="querterly" placeholder="Enter Quarterly" />
                                            <div class="mb-2 text-danger">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$plan.params.monthly" name="monthly" type="text"
                                                class="form-control" id="monthly" placeholder="Enter Monthly" />
                                            <div class="mb-2 text-danger">
