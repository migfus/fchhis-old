      ...
      <div class="row">
        <div class="col-sm-3 border-right">
          <div class="description-block">
            <h5 v-if="$user.content.user.role == 4" class="description-header">Agent</h5>
            <h5 v-else class="description-header">Client</h5>
        ...
        <div v-if="$user.content.user.role == 4" class="col-sm-3 border-right">
          <div class="description-block">
            <h5 class="description-header text-success">
              {{ $user.content.agent_clients.length }}
            </h5>
            <span class="description-text">Clients</span>
          </div>
        </div>

        <div v-else class="col-sm-3 border-right">
          <div class="description-block">
            <h5 class="description-header text-success">
        ...
        <div v-if="$user.content.user.role == 4" class="col-sm-3">
          <div class="description-block">
            <h5 class="description-header text-info">
              {{
                NumberAddComma($user.content.agent_transactions_sum_amount)
              }}
            </h5>
