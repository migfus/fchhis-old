<template>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title text-bold">Add Beneficiary</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input v-model="$ben.params.name" type="text" class="form-control" id="exampleInputEmail1"
            ...
            <button @click="$ben.config.form = null" class="btn btn-sm btn-danger float-right"><i
                    class="fas fa-times mr-1"></i>Cancel</button>
            <button @click="$ben.AddAPI()" class="btn btn-sm btn-info float-right mr-2"
