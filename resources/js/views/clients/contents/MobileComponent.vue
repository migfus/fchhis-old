                ...
                <div data-card-widget="collapse" ref="collapse-click">
                    <div class="row">
                        <div class="col-12 col-md-6 col-xl-4">
                            ...
                            <img v-if="row.avatar" :src="row.avatar" style="height: 3em;"
                                class="img-circle float-left mr-3 mt-2">
                        ...
                        <div class="d-none d-md-inline col-md-6 col-xl-4">
                            ...
                            <div>Total To Pay: <strong>{{ NumberAddComma(PlanToPay(row.pay_type, row.plan)) }}</strong>
                            </div>
                            <div>Est. Bal. Due:
