                ...
                <div class="row">
                    ...
                    <div v-if="$user.config.notify" class="col-12">
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            that they
                            transact.
                            <button @click="$user.RemoveNotify" type="button" class="close" data-dismiss="alert"
                                aria-label="Close">
                    ...
                    <div class="col-12 col-md-4 mb-2">
                        <div class="input-group input-group float-right">
                            <input v-model="$user.params.search" type="text" name="table_search"
                    ...
                    <div class="col-12 mt-2">
                        ...
                        <button v-if="$user.config.form == ''" @click="$user.ChangeForm('or')"
