<template>
  <div class="login-box mt-5">
    <div class="login-logo">
      <RouterLink :to="{ name: 'login' }">Future Care & Helping Hands Insurance Service</RouterLink>
    </div>
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <Form v-slot="{ errors }" :validation-schema="schema" validate-on-mount @submit="$auth.Login(input)">
          ...
          <div class="input-group">
            <Field v-model="input.password" name="password" type="password" class="form-control" placeholder="Password" />
            <div class="input-group-append">
              <div class="input-group-text">
