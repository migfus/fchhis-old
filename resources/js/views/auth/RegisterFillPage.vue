                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <Field v-model="$register.params.username" name="username" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <Field v-model="$register.params.email" name="email" type="email" class="form-control"
                                ...
                                <div class="form-group">
                                    <Field v-model="$register.params.password" name="password" type="password"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <Field v-model="$register.params.name" name="name" type="text" class="form-control"
                                        id="last-input" placeholder="Enter Name" />
                                    <div class="mb-2 text-danger">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <Field v-model="$register.params.bday" name="bday" type="date"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <Field as="select" name="bplace" v-model="$register.params.bplace_id"
                                                class="form-control">
                                                <option
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <label>City</label>
                                            <Field v-model="$register.params.address_id" name="addressID" as="select"
                                                class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <Field v-model="$register.params.address" name="address" type="text"
