                ...
                <div data-card-widget="collapse" ref="collapse-click">
                    <div class="row">
                        <div class="col-12 col-md-6 col-xl-4">
                            ...
                            <img v-if="row.avatar" :src="row.avatar" style="height: 2em;"
                        ...
                        <div v-else class="d-none d-md-inline col-md-6 col-xl-4">
                            Link: <a :href="row.OR" target="_blank">{{ `https://fchhis.migfus20.com/register?or=${row.or}`
                            }}</a>
                        ...
                        <div class="d-none d-xl-inline col-12 col-md-6 col-xl-4">
                            ...
                            <div v-if="row.info.plan">
                            </div>
                            {{ row.info.plan.name }}


                            <!-- <div>Plan: <strong>{{ `${row.info.plan.name} (${row.info.pay_type.name})` }}</strong></div> -->
                            <!-- <div>Total: <strong>{{ NumberAddComma(row.info.plan.spot_pay) }}</strong></div> -->
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        ...
                        <div>Created On: <strong>{{ moment(row.created_at).local().format('MMM DD, YYYY h:mm A') }}</strong>
                        </div>
                        <div>Staff: <strong>{{ row.name }}</strong></div>
